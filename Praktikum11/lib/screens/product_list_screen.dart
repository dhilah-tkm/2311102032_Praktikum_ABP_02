...
class ProductListScreen extends StatelessWidget {
  ...
  final List<Product> products = [
    Product(id: '1', name: 'MacBook Pro M3', price: 25000000),
    Product(id: '2', name: 'iPhone 15 Pro', price: 18000000),
    Product(id: '3', name: 'AirPods Pro 2', price: 3500000),
    Product(id: '4', name: 'Keychron K2 Keyboard', price: 1500000),
    Product(id: '5', name: 'Logitech MX Master 3S', price: 1200000),
  ];
